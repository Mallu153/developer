...
@Component({
  selector: 'app-booking-search-supplier-reference',
  templateUrl: './booking-search-supplier-reference.component.html',
  styleUrls: ['./booking-search-supplier-reference.component.scss','../../../../../../assets/sass/libs/select.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class BookingSearchSupplierReferenceComponent implements OnInit ,OnDestroy{
  ...
  getBookingData() {
    ...
    this.loading = true;
    this.srReports
      .getBookingReportBySupplier(this.bookingSearchForm.value, sr_reports.bookingReportBySupplier)
      .pipe(takeUntil(this.ngDestroy$))
      .subscribe(
        (res) => {
  ...
  getBookingInforamtionByCustomer(objectInfo) {
    ...
    this.loading = true;
    this.srReports
      .getBookingReportBySupplier(objectInfo, sr_reports.bookingReport)
      .pipe(takeUntil(this.ngDestroy$))
      .subscribe(
        (res) => {
          const result: BookingReportsApiResponse = res;
