...
@Component({
  selector: 'app-booking-report-supplier-reference',
  templateUrl: './booking-report-supplier-reference.component.html',
  styleUrls: ['./booking-report-supplier-reference.component.scss','../../../../../../assets/sass/libs/datatables.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class BookingReportSupplierReferenceComponent implements OnInit ,OnChanges, OnDestroy  {
  ...
  @Input() public SupplierReportsData: any[];
  ...
  constructor(
    ...
    this.titleService.setTitle('Retail Booking Report List');
  ...
  ngOnChanges() {
    if (this.SupplierReportsData) {
      this.bookingData = this.SupplierReportsData;
      this.rows = this.SupplierReportsData;
    } else {
      this.rows = [];
    }
  }
