...
@Component({
  selector: 'app-agent-cash-list',
  templateUrl: './agent-cash-list.component.html',
  styleUrls: ['./agent-cash-list.component.scss','../../../../../../assets/sass/libs/datatables.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class AgentCashListComponent implements OnInit, OnDestroy {
  pageTitle = 'Agent Cash List';
  ...
  constructor(
    ...
    private storeManagementApi:CashManagementService
      ...
      this.titleService.setTitle('Agent Cash Transactions');
    }
  ...
  agentCashData(){
    this.loading=true;
    this.storeManagementApi.getAgentCashData(this.authService.getUser(),getAgentAllCashTransactions.CASH_URL).pipe(takeUntil(this.ngDestroy$)).subscribe((res:CashManagementApiResponse) => {
